...
3. use pretrain model13 eng in {filename}_pretrain
4. verX means not with pretrain model13
'''
...
def training(model):
    # 把結果寫入檔案
    file = open("training_result_model13_CH/training_detail_model13_CH_ver1.txt", "w")
    # 紀錄最大驗證集準確率
    max_accuracy = 0
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if(accuracy_valid > max_accuracy):
            ...
            if save_parameters:
                path = 'training_result_model13_CH/model_13_CH_ver1.pth'
    ...
    plt.savefig("training_result_model13_CH/CH_ROC13_ver1.png") 

    # confusion_matrix
    plt.figure()
    cm = confusion_matrix(all_label, all_pred)
    sns.heatmap(cm, annot=True)
    plt.savefig("training_result_model13_CH/CH_Confusion_matrix13_ver1.png") 
...
def plt_loss_accuracy_fig(Total_training_loss, Total_validation_loss, Total_training_accuracy, Total_validation_accuracy):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig("training_result_model13_CH/CH_Loss13_ver1.png") 
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig("training_result_model13_CH/CH_Accuracy13_ver1.png") 
...
if __name__ == "__main__":
    ...
    # # load P_model13 pth
    # pth_path = 'training_result_model13_ENG/model_13_ENG_ver1.pth'
    ...
    # Load Images from a Folder
    image_folder_path = r"D:\clone_audio\chinese_audio_dataset_ver3\val_mel_spec_padding_original_audio"

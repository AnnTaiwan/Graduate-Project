...
3. Use mel_spec without padding to 5 seconds.
'''
...
def training(model):
    # 把結果寫入檔案
    file = open("training_result_mel_spec_ver2/training_detail_model9_CH.txt", "w")
    # 紀錄最大驗證集準確率
    max_accuracy = 0
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if(accuracy_valid > max_accuracy):
            ...
            if save_parameters:
                path = 'training_result_mel_spec_ver2/model_9_CH_ver1.pth'
    ...
    plt.savefig("training_result_mel_spec_ver2/CH_ROC9.png") 

    # confusion_matrix
    plt.figure()
    cm = confusion_matrix(all_label, all_pred)
    sns.heatmap(cm, annot=True)
    plt.savefig("training_result_mel_spec_ver2/CH_Confusion_matrix9.png") 
...
def plt_loss_accuracy_fig(Total_training_loss, Total_validation_loss, Total_training_accuracy, Total_validation_accuracy):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig("training_result_mel_spec_ver2/CH_Loss9.png") 
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig("training_result_mel_spec_ver2/CH_Accuracy9.png") 
...
if __name__ == "__main__":
    ...
    image_folder_path = r"D:\clone_audio\chinese_audio_dataset_ver3\train_mel_spec_without_padding"
    ...
    # Load Images from a Folder
    image_folder_path = r"D:\clone_audio\chinese_audio_dataset_ver3\val_mel_spec_without_padding"

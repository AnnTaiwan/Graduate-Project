...
5. adjust the model_9 inter channels number to [20,44,15,8] 
----------------------------------------------------------
ver1:
LR = 0.005
batch_size_train = 50
...
# define CNN model
class CNN_model14(nn.Module):
    def __init__(self):
        super(CNN_model14, self).__init__()
        ...
        # final layer output above is (10, 2, 2) 
...
def training(model):
    # 把結果寫入檔案
    file = open("training_result_model14_ENG/training_detail14_ENG_ver1.txt", "w")
    # 紀錄最大驗證集準確率
    max_accuracy = 0
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if(accuracy_valid > max_accuracy):
            ...
            if save_parameters:
                path = 'training_result_model14_ENG/model_14_ENG_ver1.pth'
    ...
    plt.savefig("training_result_model14_ENG/ENG_ROC14_ver1.png") 

    # confusion_matrix
    plt.figure()
    cm = confusion_matrix(all_label, all_pred)
    sns.heatmap(cm, annot=True)
    plt.savefig("training_result_model14_ENG/ENG_Confusion_matrix14_ver1.png") 
...
def plt_loss_accuracy_fig(Total_training_loss, Total_validation_loss, Total_training_accuracy, Total_validation_accuracy):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig("training_result_model14_ENG/ENG_Loss14_ver1.png") 
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig("training_result_model14_ENG/ENG_Accuracy14_ver1.png") 

...
2. input mel_spec, mfcc, and chroma stacked image ,and use RGB pixel value as input feature
3. padding the original audio into 5 seconds.
...
def training(model):
    # 把結果寫入檔案
    file = open("training_result_Combined_Features_model9_ENG/training_detail9_ENG_ver1.txt", "w")
    # 紀錄最大驗證集準確率
    max_accuracy = 0
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if(accuracy_valid > max_accuracy):
            ...
            if save_parameters:
                path = 'training_result_Combined_Features_model9_ENG/model_9_ENG_ver1.pth'
    ...
    plt.savefig("training_result_Combined_Features_model9_ENG/ENG_ROC9_ver1.png") 

    # confusion_matrix
    plt.figure()
    cm = confusion_matrix(all_label, all_pred)
    sns.heatmap(cm, annot=True)
    plt.savefig("training_result_Combined_Features_model9_ENG/ENG_Confusion_matrix9_ver1.png") 
...
def plt_loss_accuracy_fig(Total_training_loss, Total_validation_loss, Total_training_accuracy, Total_validation_accuracy):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig("training_result_Combined_Features_model9_ENG/ENG_Loss9_ver1.png") 
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig("training_result_Combined_Features_model9_ENG/ENG_Accuracy9_ver1.png") 
...
if __name__ == "__main__":
    ...
    image_folder_path = r"D:\clone_audio\ASVspoof2019_MyDataset\dataset_ver1\Image_noise20db_ver\train_Combined_Features_padding_original_audio"
    ...
    # Load Images from a Folder
    image_folder_path = r"D:\clone_audio\ASVspoof2019_MyDataset\dataset_ver1\Image_noise20db_ver\val_Combined_Features_padding_original_audio"

...
from P_model_14_ENG import IMAGE_SIZE, CNN_model14
...
if __name__ == "__main__":
    ...
    model.to(device)
    pth_path = 'training_result_model14_ENG/model_14_ENG_ver1.pth'
    ...
    image_folder_path = r"D:\clone_audio\ASVspoof2019_MyDataset\dataset_ver1\Image_noise20db_ver\test_mel_spec_padding_original_audio"
    ...
    csv_file_path = "training_result_model14_ENG/testing_result14_ENG_ver1.csv"

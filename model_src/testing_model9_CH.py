...
if __name__ == "__main__":
    ...
    model.to(device)
    state_dict = torch.load('training_result_mel_spec/model_9_CH_ver1.pth')
    model.load_state_dict(state_dict)
    # set loss function
    criterion = nn.CrossEntropyLoss()

    # Load Images from a Folder
    image_folder_path = r"D:\clone_audio\chinese_audio_dataset_ver3\test_mel_spec"
    ...
    csv_file_path = f"training_result_mel_spec/testing_result9_CH_ver1.csv"

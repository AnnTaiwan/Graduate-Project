...
from P_model_9_ENG_stacked_features import IMAGE_SIZE, CNN_model9
...
if __name__ == "__main__":
    ...
    model.to(device)
    state_dict = torch.load('training_result_Combined_Features_model9_ENG/model_9_ENG_ver1.pth')
    model.load_state_dict(state_dict)
    # set loss function
    criterion = nn.CrossEntropyLoss()

    # Load Images from a Folder
    image_folder_path = r"D:\clone_audio\ASVspoof2019_MyDataset\dataset_ver1\Image_noise20db_ver\test_Combined_Features_padding_original_audio"
    ...
    csv_file_path = "training_result_Combined_Features_model9_ENG/testing_result9_ENG_ver1.csv"

...
from P_model_13_ENG import IMAGE_SIZE, CNN_model13
...
if __name__ == "__main__":
    ...
    model.to(device)
    pth_path = 'training_result_model13_ENG/model_13_ENG_ver2.pth'
    ...
    csv_file_path = "training_result_model13_ENG/testing_result13_ENG_ver2.csv"

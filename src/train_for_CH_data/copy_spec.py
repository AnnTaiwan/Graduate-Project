'''
copy spectrogram into another folder
'''
import os
import random
import shutil

def copy_random_files(source_dir, destination_dir, num_files):
...
source_directory = r"D:\clone_audio\chinese_audio_spec\bonafide_spec_base\part_1"
destination_directory = r"D:\clone_audio\chinese_audio_spec\Vitis_ai_train_S303_Bpart1"

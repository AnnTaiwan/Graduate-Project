...
def training(model):
    # 把結果寫入檔案
    file = open(r"D:\graduate_project\src\version2\training_detail_model1.txt", "w")
    ...
    plt.savefig(r"D:\graduate_project\src\version2\ROC1.png") 

    # confusion_matrix
    plt.figure()
    cm = confusion_matrix(all_label, all_pred)
    sns.heatmap(cm, annot=True)
    plt.savefig(r"D:\graduate_project\src\version2\Confusion_matrix1.png") 
...
def plt_loss_accuracy_fig(Total_training_loss, Total_validation_loss, Total_training_accuracy, Total_validation_accuracy):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig(r"D:\graduate_project\src\version2\Loss1.png") 
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig(r"D:\graduate_project\src\version2\Accuracy1.png") 

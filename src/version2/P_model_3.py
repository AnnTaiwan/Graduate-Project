...
def training(model):
    ...
    plt.savefig(r"D:\graduate_project\src\version2\ROC3.png") 

    # confusion_matrix
    plt.figure()
    cm = confusion_matrix(all_label, all_pred)
    sns.heatmap(cm, annot=True)
    plt.savefig(r"D:\graduate_project\src\version2\Confusion_matrix3.png") 
...
def plt_loss_accuracy_fig(Total_training_loss, Total_validation_loss, Total_training_accuracy, Total_validation_accuracy):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig(r"D:\graduate_project\src\version2\Loss3.png") 
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig(r"D:\graduate_project\src\version2\Accuracy3.png") 

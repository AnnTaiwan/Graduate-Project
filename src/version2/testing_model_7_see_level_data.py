'''
Can use print_tensor_hook to see each layer's value.
'''
...
if __name__ == "__main__":
    ...
    model = CNN_model7()
    model.to(device)
    state_dict = torch.load(r"D:\graduate_project\src\version2\model_7.pth")
    ...
    image_folder_path = r"D:\graduate_project\src\spec_LAEval_audio_shuffle1_NOT_preprocessing"
